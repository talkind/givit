...
class Profile(models.Model):
    ...
    phone_number = models.CharField(help_text='example: 0544544554', max_length=10, validators=[phone_regex])
    date_of_birth = models.DateField(max_length=8, help_text='mm/dd/yyyy')
    address_street_name = models.CharField(max_length=50, verbose_name='street')
    address_house_number = models.CharField(max_length=3, verbose_name='home_number', validators=[house_number_regex])
    address_city = models.CharField(max_length=50, verbose_name='city')
    field_of_study = models.CharField(max_length=100, default='Computer Science', choices=FIELD_OF_STUDY)
